...
{
    public class ManageSales : SomeCommanFeiled
    {
        ...
        AgainAndAgain:
            ...
            switch (choise)
            {
                ...
                addmore:
                    ...
                    arrayList.Add(date);
                    AddnewItem(@"D:\aspdotnet\CSharpOPPsRepo\Food _Cour_ Managemen_ System\sales.txt", arrayList);
                    arrayList.Clear();
                ...
                case 2:
                    ...
                    ViewDetailsOfItems(showcatid, showcatname, @"D:\aspdotnet\CSharpOPPsRepo\Food _Cour_ Managemen_ System\sales.txt");
                    goto AgainAndAgain;
                case 3:
                ...
                updatemore:
                    ...
                    ViewDetailsOfItems(updatesalesid, updatesalesname, @"D:\aspdotnet\CSharpOPPsRepo\Food _Cour_ Managemen_ System\sales.txt");
                    ...
                    arrayList.Add(date2);
                    UpdateExistItem(updatesalesid, updatesalesname, arrayList, @"D:\aspdotnet\CSharpOPPsRepo\Food _Cour_ Managemen_ System\sales.txt");
                    arrayList.Clear();
                    Console.Write(" Do you Want more Press 1:");
